...
func CalculateContainerStats(id string, name string, stats *container.StatsResponse) *ContainerStats {
	if stats == nil {
		return &ContainerStats{ID: id, Name: name}
	}
...
func BuildContainerConfig(req CreateContainerRequest) (*container.Config, *container.HostConfig, error) {
